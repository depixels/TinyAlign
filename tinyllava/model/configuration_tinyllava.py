...
class TinyLlavaConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.connector2_type = connector2_type
        self.top_rag = top_rag
        self.retrieval_memory_dir = retrieval_memory_dir
        self.retrieval_index_file = retrieval_index_file
        self.retrieval_value_file = retrieval_value_file
        self.retrieval_text_start = retrieval_text_start
        self.retrieval_alpha = retrieval_alpha
        self.tune_type_llm = tune_type_llm
        self.tune_type_connector = tune_type_connector
        self.tune_type_connector2 = tune_type_connector2
        ...
        self.rag_token_index = RAG_TOKEN_INDEX
    ...
    def load_from_config(self, config):
        ...
        self.connector2_type = getattr(config, 'connector2_type',  None)
        self.top_rag = getattr(config, 'top_rag', 1)
        self.retrieval_memory_dir = getattr(config, 'retrieval_memory_dir', None)
        self.retrieval_index_file = getattr(config, 'retrieval_index_file', 'Merged_faiss.index')
        self.retrieval_value_file = getattr(config, 'retrieval_value_file', 'Merged_LLaVA_Dataset_Memory.pt')
        self.retrieval_text_start = getattr(config, 'retrieval_text_start', 35)
        self.retrieval_alpha = getattr(config, 'retrieval_alpha', 0.4)
