...
class ModelArguments:
    ...
    connector2_type: Optional[str] = field(default='linear')
    top_rag : Optional[int] = field(default=1)
    retrieval_memory_dir: Optional[str] = field(default=None)
    retrieval_index_file: str = field(default='Merged_faiss.index')
    retrieval_value_file: str = field(default='Merged_LLaVA_Dataset_Memory.pt')
    retrieval_text_start: int = field(default=35)
    retrieval_alpha: float = field(default=0.4)
...
class TrainingArguments(transformers.TrainingArguments):
    ...
    tune_type_connector2: str = field(default="full") # support only: frozen, full
    ...
    pretrained_connector2_path: Optional[str] = field(default=None)
